...
(function(){
  var pg, crypto, bcrypt, colors, lderror, re2, reEmail, isEmail, ret;
  pg = require('pg');
  ...
  re2 = require('re2');
  reEmail = new re2("^[-a-z0-9~!$%^&*_=+}{'?]+(.[-a-z0-9~!$%^&*_=+}{'?]+)*@([a-z0-9_][-a-z0-9_]*(.[-a-z0-9_]+)*.[a-z]{2,}|([0-9]{1,3}.[0-9]{1,3}.[0-9]{1,3}.[0-9]{1,3}))(:[0-9]{1,5})?$", re2.ignoreCase);
  isEmail = function(it){
