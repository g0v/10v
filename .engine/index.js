...
(function(){
  var express, colors, path, pino, lderror, pinoHttp, redis, util, bodyParser, csurf, i18nextHttpMiddleware, auth, route, watch, redisNode, i18n, aux, pug, postgresql, secret, defaultConfig, backend;
  ...
  backend.prototype = import$(Object.create(Object.prototype), {
    ...
    start: function(){
      ...
      return Promise.resolve().then(function(){
        ...
        api.get('/auth/info', function(req, res){
          ...
          payload = JSON.stringify({
            ...
            user: req.user
              ...
              : {},
            recaptcha: {
              sitekey: (ref$ = (ref1$ = this$.config).grecaptcha || (ref1$.grecaptcha = {})).sitekey,
              enabled: ref$.enabled
            }
          });
