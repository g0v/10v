...
(function(){
  var express, colors, path, pino, lderror, pinoHttp, redis, util, bodyParser, csurf, route, watch, redisNode, pug, postgresql, defaultConfig, backend, config;
  ...
  import$(backend, {
    ...
    middleware: {
      errorHandler: function(err, req, res, next){
        ...
        req.log.error({
          err: err
        }, "unhandled exception occurred".red);
  ...
  backend.prototype = import$(Object.create(Object.prototype), {
    ...
    start: function(){
      ...
      return Promise.resolve().then(function(){
        ...
        app.use('/api', this$.route.api = api = express.Router({
          mergeParams: true
        }));
        route(this$);
