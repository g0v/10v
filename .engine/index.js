...
(function(){
  var express, colors, path, pino, lderror, pinoHttp, redis, util, bodyParser, csurf, i18nextHttpMiddleware, srcbuild, auth, errorHandler, route, redisNode, i18n, aux, pug, postgresql, secret, defaultConfig, backend;
