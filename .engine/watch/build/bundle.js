...
(function(){
  var fs, fsExtra, livescript, stylus, path, colors, uglifyJs, uglifycss, requireReload, aux, debounce, reload, cwd, bundle, task, bundleFile, build, batch, main;
  fs = require('fs');
  ...
  main = {
    ...
    build: function(list){
      ...
      if (in$(bundleFile, list)) {
        try {
          bundle = reload(path.join('../../..', bundleFile));
          for (type in bundle) {
