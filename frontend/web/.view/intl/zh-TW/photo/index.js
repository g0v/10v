...
pug_html = pug_html + "\u003Cscript type=\"module\"\u003Evar cfg,view,ctx,altsize,fetch,handler;cfg={batchCount:100,delay:5e3};view=new ldview({initRender:false,root:document.body,ctx:{},handler:{wall:function(t){var e,c,i;e=t.node,c=t.ctx;i=+e.getAttribute(\"data-name\");e.classList.toggle(\"active\",i===c.last);if(c.cell[i].img){return e.style.backgroundImage=\"url(\"+c.cell[i].img+\")\"}}}});ctx={idx:0,last:1,cell:{0:{},1:{}},photos:[],page:10,photoSize:{}};view.setCtx(ctx);window.jsonFlickrApi=function(t){var e,c,i;console.log(\"here\",t);if(t.sizes){t.sizes.size.sort(function(t,e){return Math.abs(t.width-1600)-Math.abs(e.width-1600)});if(e=t.sizes.size[0]){c=\u002F\\\u002F([^_\u002F]+?)_\u002F.exec(e.source);if(c&&(i=c[1])){ctx.photoSize[i]=t.sizes;if((ctx.script||(ctx.script={})).size){ctx.script.size.parentNode.removeChild((ctx.script||(ctx.script={})).size);ctx.script.size=null}return handler({id:i})}}}else{if(t&&(t.photos||(t.photos={})).photo&&Array.isArray(t.photos.photo)){ctx.photos=ctx.photos.concat(t.photos.photo);console.log(t.photos.photo.length+\" images fetched. (current total: \"+ctx.photos.length+\")\");if(t.photos.photo.length\u003Ccfg.batchCount){ctx.end=true}return handler()}else{console.log(\"fetch terminated.\");return ctx.end=true}}};altsize=function(t){var e,c,i,r,o,s,n;e=t.id;c={method:\"flickr.photos.getSizes\",api_key:\"48529335b781d54b580fce46e75e126a\",photo_id:e,format:\"json\"};i=function(){var t,e=[];for(r in t=c){o=t[r];e.push([r,o])}return e}().map(function(t){var e,c;e=t[0],c=t[1];return e+\"=\"+c}).join(\"&\");s=\"https:\u002F\u002Fapi.flickr.com\u002Fservices\u002Frest?\"+i;n=document.createElement(\"script\");(ctx.script||(ctx.script={})).size=n;n.setAttribute(\"src\",s);return document.body.appendChild(n)};fetch=function(){var c,t,i,r,e;c={page:ctx.page=ctx.page+1,per_page:cfg.batchCount,method:\"flickr.photos.search\",user_id:\"129321464@N04\",api_key:\"48529335b781d54b580fce46e75e126a\",format:\"json\"};t=function(){var t,e=[];for(i in t=c){r=t[i];e.push([i,r])}return e}().map(function(t){var e,c;e=t[0],c=t[1];return e+\"=\"+c}).join(\"&\");e=document.createElement(\"script\");e.setAttribute(\"src\",\"https:\u002F\u002Fapi.flickr.com\u002Fservices\u002Frest?\"+t);return document.body.appendChild(e)};handler=function(t){var e,c,i,r,o,s,n;t==null&&(t={});if(e=ctx.photos[ctx.idx]){c=e.server,i=e.id,r=e.secret;console.log(\"load \"+ctx.idx+\" \u002F \"+i+\" ...\",t.id?\"(size updated)\":\"\");if(!t.id&&!ctx.photoSize[i]){return altsize({id:i})}else if(t.id&&(o=ctx.photoSize[t.id])){ctx.last=1-ctx.last;ctx.cell[ctx.last].img=s=o.size[0].source;n=new Image;n.onload=function(){ctx.idx++;view.render();return setTimeout(handler,cfg.delay)};return n.src=s}else{ctx.last=1-ctx.last;ctx.cell[ctx.last].img=s=\"https:\u002F\u002Flive.staticflickr.com\u002F\"+c+\"\u002F\"+i+\"_\"+r+\"_b.jpg\";n=new Image;n.onload=function(){ctx.idx++;view.render();return setTimeout(handler,cfg.delay)};return n.src=s}}else if(!ctx.end){return fetch()}else{ctx.idx=0;return setTimeout(handler,cfg.delay)}};handler();\u003C\u002Fscript\u003E\u003C\u002Fbody\u003E\u003C\u002Fhtml\u003E";
