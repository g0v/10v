...
(function(){
  var fs, yargs, express, colors, path, pino, lderror, pinoHttp, redis, util, bodyParser, csurf, i18nextHttpMiddleware, srcbuild, pug, errorHandler, redisNode, mailQueue, i18n, aux, postgresql, auth, consent, captcha, libdir, rootdir, routes, argv, cfgName, secret, e, withDefault, defaultConfig, backend;
  fs = require('fs');
  yargs = require('yargs');
