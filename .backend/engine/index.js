...
(function(){
  var fs, yargs, express, colors, path, pino, lderror, pinoHttp, redis, util, bodyParser, csurf, i18nextHttpMiddleware, srcbuild, pug, errorHandler, redisNode, auth, i18n, aux, postgresql, libdir, routes, argv, cfgName, secret, e, defaultConfig, backend;
  fs = require('fs');
  yargs = require('yargs');
