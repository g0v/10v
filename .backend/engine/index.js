...
(function(){
  var fs, yargs, express, colors, path, pino, lderror, pinoHttp, redis, util, bodyParser, csurf, i18nextHttpMiddleware, srcbuild, pug, errorHandler, redisNode, mailQueue, captcha, auth, consent, i18n, aux, postgresql, libdir, routes, argv, cfgName, secret, e, withDefault, defaultConfig, backend;
  fs = require('fs');
  yargs = require('yargs');
  ...
  consent = require('backend/consent');
  i18n = require('backend/i18n');
