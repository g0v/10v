...
(function(){
  var yargs, express, colors, path, pino, lderror, pinoHttp, redis, util, bodyParser, csurf, i18nextHttpMiddleware, srcbuild, pug, errorHandler, route, redisNode, auth, i18n, aux, postgresql, argv, cfgName, secret, defaultConfig, backend;
  yargs = require('yargs');
